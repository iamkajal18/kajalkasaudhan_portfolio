...
function Navbar() {
  return (
    <div>
<nav className="fixed top-0 left-0 w-full bg-gray-300 border-gray-200 dark:bg-gray-900">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
  <Link href="/">
  <img src="/blog.png" alt="logo" className="w-14 rounded-lg p-1 h-9 cursor-pointer" />
</Link>
  ...
  <div className="items-center bg-white-500 justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-gray-300 sm:bg-green-950 dark:bg-gray-800 md:dark:bg-gray-900  dark:border-gray-700">
      <li>
